...
import UserContractDetail from "./pages/UserContractDetail";
import LawyerContractDetail from "./pages/LawyerContractDetail";
import Tosign from "./pages/Tosign";
import Signed from "./pages/Signed";
import AwaitingSignature from "./pages/AwaitingSignature";
import LawyerAwaitingSignature from "./pages/LawyerAwaitingSignature";
import Overdue from "./pages/Overdue";
import Devuelto from "./pages/Devuelto";
import Vencido from "./pages/Vencido";
import LawyerNewContracts from "./pages/LawyerNewContracts";
import LawyerManagedContracts from "./pages/LawyerManagedContracts";
import LawyerAwaitingReviewContracts from "./pages/LawyerAwaitingReviewContracts";
import UserSentContracts from "./pages/UserSentContracts";
import UserAwaitingResponseContracts from "./pages/UserAwaitingResponseContracts";
import UserFinalizado from "./pages/UserFinalizado";
import LawyerFinalizado from "./pages/LawyerFinalizado";
