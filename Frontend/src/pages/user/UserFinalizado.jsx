...
const UserFinalizado = () => {
    ...
    const fetchContracts = useCallback(async () => {
        ...
        try {
            ...
            const contracts = await getFinalizadoContracts(filters);
            ...
            {loading ? (
                ...
                <div className="text-center py-10">
                    <div className="inline-flex items-center px-4 py-2 font-semibold leading-6 text-gray-500 dark:text-gray-400 shadow rounded-md">
                        {filter || ticketFilter ? 'No hay contratos que coincidan con los filtros aplicados.' : 'No hay contratos finalizados disponibles.'}
                    </div>
                </div>
            ) : (
