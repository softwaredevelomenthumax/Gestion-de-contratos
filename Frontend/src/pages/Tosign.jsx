...
const Tosign = () => {
    ...
    const fetchContracts = async () => {
        ...
        try {
            ...
            const toSignContracts = allContracts.filter(contract => contract.estado === 'firmado'); // Assuming 'firmado' means 'to sign'
            setContracts(toSignContracts);
        } catch (err) {
    ...
    return (
        <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            ...
            {loading ? (
                ...
                <div className="text-center py-10">
                    <div className="inline-flex items-center px-4 py-2 font-semibold leading-6 text-gray-500 dark:text-gray-400 shadow rounded-md">
                        No hay contratos para firmar disponibles.
                    </div>
                </div>
            ) : (
