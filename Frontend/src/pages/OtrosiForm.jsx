...
const handleFileChange = (e) => {
  ...
  if (file) {
    if (allowedTypes.includes(file.type) && file.size <= 30 * 1024 * 1024) {
      ...
      setErrors((prev) => ({
        ...prev,
        cartaSolicitud: "Solo se permiten archivos PDF, DOC o DOCX menores a 30MB",
      }));
  ...
  if (file) {
    if (allowedTypes.includes(file.type) && file.size <= 30 * 1024 * 1024) {
      ...
      setErrors((prev) => ({
        ...prev,
        firmarOtrosi: "Solo se permiten archivos PDF, DOC o DOCX menores a 30MB",
      }));
 ...
 const handleEnviarOtrosiChange = (e) => {
  ...
  if (file) {
    if (allowedTypes.includes(file.type) && file.size <= 30 * 1024 * 1024) {
      ...
      setErrors((prev) => ({
        ...prev,
        enviarOtrosi: "Solo se permiten archivos PDF, DOC o DOCX menores a 30MB",
      }));
