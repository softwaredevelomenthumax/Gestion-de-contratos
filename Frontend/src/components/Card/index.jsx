    ...
    return (
      ...
      >
        ...
        <div className="p-5">
          ...
          <h3 className="text-lg font-semibold text-foreground mb-1 break-words whitespace-normal leading-snug group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
            {contract?.proveedor || 'Sin proveedor'}
          </h3>
